...
const modify_style = document.querySelectorAll('.admin-link-modify');
...
<b>Link </b>- <a href="${task.doc_link}" target="_child">Document Link</a></p>
            </div>
            <div class="col-md-4">
              <center><h3><span class="badge badge-${task.status_color}">${task.status}</span>
              <button class="btn btn-outline-info modify_button admin-link-modify"  onclick="modify_function(this)">Modify</button>
              </h3></p></center>
            </div>
...
<b>Publishing Time </b>- ${task.pub_time}</p>
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center">
              <center><h2><span class="badge badge-${task.status_color}">${task.status}</span>
